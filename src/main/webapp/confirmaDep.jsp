...
if (request.getAttribute("confirmado") != null){
	...
	type = "reset";
%>
<meta http-equiv="refresh" content="2; URL='http://localhost:8080/urnaEletronicaWeb/votarPres.jsp'"/> <!--Define o redirecionamento, tempo e URL--->
<%
}
%>
<title>Urna</title>
...
<body>
	<h1>Confirmar para Deputado</h1>
	<p>Seu voto esta indo para</p>
	<form class="votandoCandidatos" action="confirmaDepController" method="post">
	<%
	int temCandidato = 0;
